...
for i = 1:datasize
  feature2(i,1) = Apen(5,0.5,hasil1(i,:));        
end
for i = 1:datasize
  feature3(i,1) = Apen(5,0.5,hasil1(i,:));        
end
for i = 1:datasize
  feature4(i,1) = Apen(5,0.5,hasil1(i,:));        
end
for i = 1:datasize
  feature5(i,1) = Apen(5,0.5,hasil1(i,:));        
end
for i = 1:datasize
  feature6(i,1) = Apen(5,0.5,hasil1(i,:));        
end